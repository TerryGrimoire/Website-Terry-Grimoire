...
const partenairesData = [
  ...
  },
  {
    ...
    links: "/",
    description:
      "Data Analyst en poste, Charles Girouard nous a fait confiance pour construire son portefolio en ligne. Véritable CV qui permet de voir non seulement son expérience mais également les différents projets sur lesquels il a travaillé, nous avons travaillé ensemble dans l'élaboration de la maquette, du design et du contenu de son portefolio.",
  },
  {
    id: 1,
    title: "We Rev Art",
