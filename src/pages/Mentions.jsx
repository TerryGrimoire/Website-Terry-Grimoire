  ...
  return (
    <div className="mentions">
      ...
      <p>
        ...
        <a href="https://www.grimoire-site.com">
          https://www.grimoire-site.com
        </a>
      ...
      <p>
        <strong>Propriétaire</strong> : Grimoire – 47 avenue de la Gare de St
        Joseph Nantes
        <br />
        <strong>Responsable publication</strong> : Terry Grimoire – 07 67 84 67
        27 07
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Terry Grimoire – terry.grimoire@gmail.com
        <br />
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Grimoire.
        <a href="https://www.grimoire-site.com">
          https://www.grimoire-site.com
        </a>
        est représenté par Terry Grimoire, son représentant légal
      </p>
      <p>
      ...
      Grimoire – DPO, Cnil Cnil <br /> 47 avenue de la Gare de St Joseph Nantes.
      <p>
